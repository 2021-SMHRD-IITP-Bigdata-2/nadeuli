    ...
    <div class="board_wrap">
        ...
        <div class="board_list_wrap">
            <div class="board_list">
                ...
                <div>
                    <div class="num">5</div>
                    <div class="area">여수</div>
                    <div class="title"><a href="board_view.html"> 나드리에서 추천해준 여수여행 후기 남겨요~</a></div>
                    <div class="writer">김두환</div>
                    <div class="date">2021.8.2</div>
                    <div class="count">36</div>
                </div>
                <div>
                    <div class="num">4</div>
                    <div class="area">순천</div>
                    <div class="title"><a href="board_view.html">순천에서 가족들과 함께</a></div>
                ...
                <div>
                    <div class="num">3</div>
                    <div class="area">곡성</div>
                    <div class="title"><a href="board_view.html">곡성기차마을 다녀왔어요!</a></div>
                    <div class="writer">유관순</div>
                ...
                <div>
                    ...
                    <div class="title"><a href="board_view.html">광주 무등산 등반</a></div>
                    <div class="writer">장영우</div>
                    <div class="date">2021.7.28</div>
                    <div class="count">75</div>
                </div>
                <div>
                    <div class="num">1</div>
                    <div class="area">목포</div>
                    <div class="title"><a href="board_view.html">목포해상 케이블카 체험후기 </a></div>
                    <div class="writer">박나래</div>
            ...
            <div class="bt_wrap">
                <a href="board_write.html" class="on">글쓰기</a>
                <!--<a href="#">수정</a>-->
            </div>
        </div>
    </div>
