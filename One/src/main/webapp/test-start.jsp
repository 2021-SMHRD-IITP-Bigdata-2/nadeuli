...
<body>
  <div id="preloader">
                    ...
                    <div class="col-md-2 col-md-offset-5  col-sm-3 col-sm-offset-1  col-xs-12">
                        <div class="header-half header-social">
                            <ul class="list-inline">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li> <!-- 최상단 버튼 -->
                ...
                <div class="row">
                    <div class="page-head-content">
                    	<div class="image-container">
                        	...
                        	<h1 class="page-title">맞춤 여행 테스트</h1>
                        </div>               
                    </div>
                </div>
            </div>
        ...
        <div class="properties-area recent-property" style="background-color: #FFF;">
            <div class="container">  
                <div class="row" id="iframe-div">
                	<iframe class="test_iframe"
						    src="test-main.jsp">
							<!-- 만약 iframe 뜨지않으면 제공할 정보를 입력해야한다. -->  
							</iframe>
                            ...
                            <div class="col-sm-6 col-md-4 p0">
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 여수 </a></h5>
                                            <div class="dot-hr"></div>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 순천 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 목포 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 나주 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 광양 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 담양 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 곡성 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> 구례 </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> Area :</b> 120m </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
